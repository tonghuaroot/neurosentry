...
ssh -i ~/.ssh/your-key.pem ubuntu@13.209.69.99
...
The NeuroSentry test server (13.209.69.99) runs Ubuntu 24.04 with kernel 6.14:

```bash
# SSH to server
ssh -i ~/.ssh/java-sec-code.pem ubuntu@13.209.69.99
